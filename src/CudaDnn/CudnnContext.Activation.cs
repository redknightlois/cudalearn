...
namespace CudaDnn
{
    ...
    {
        public void Forward(CudnnActivationMode mode, CudnnTensorDescriptor srcTensor, CudaDeviceVariable<float> srcData, CudnnTensorDescriptor destTensor, CudaDeviceVariable<float> destData)
        {
        ...
        public void Backward(CudnnActivationMode mode, CudnnTensorDescriptor srcTensor, CudaDeviceVariable<double> srcData, CudnnTensorDescriptor srcDiffTensor, CudaDeviceVariable<double> srcDiffData,
        ...
        public void Forward(CudnnActivationMode mode, CudnnTensorDescriptor srcTensor, float[] srcData, CudnnTensorDescriptor destTensor, float[] destData)
        {
            Contract.Requires(srcTensor != null);
            Contract.Requires(srcData != null);
            Contract.Requires(destTensor != null);
            ...
            using (var destDataGpu = new CudaDeviceVariable<float>(destData.Length))
            {
                ...
                Invoke(() => CudnnNativeMethods.cudnnActivationForward(handle, mode,
                                                                       srcTensor.Handle, srcDataGpu.DevicePointer, destTensor.Handle, destDataGpu.DevicePointer));
                destDataGpu.CopyToHost(destData);
            }
        }

        public void Forward(CudnnActivationMode mode, CudnnTensorDescriptor srcTensor, double[] srcData, CudnnTensorDescriptor destTensor, double[] destData)
        {
            Contract.Requires(srcTensor != null);
            Contract.Requires(srcData != null);
            Contract.Requires(destTensor != null);
        ...
        public void Backward(CudnnActivationMode mode, CudnnTensorDescriptor srcTensor, float[] srcData, CudnnTensorDescriptor srcDiffTensor, float[] srcDiffData,
        ...
        public void Backward(CudnnActivationMode mode, CudnnTensorDescriptor srcTensor, double[] srcData, CudnnTensorDescriptor srcDiffTensor, double[] srcDiffData,
